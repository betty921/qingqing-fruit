...
<form class="form-horizontal" role="form" action="?r=product/add" method="post">
    ...
    <div class="form-group">
        ...
        <div class="col-sm-10">
            <select name="top_class_id" class="col-xs-10 col-sm-5" onchange="getSecondMenu(this)">
                ...
                <option value="<?= $topMenu['class_id'] ?>"><?= $topMenu['class_name'] ?></option>
                <?php endforeach;?>
            </select>
    ...
    <div class="form-group">
        ...
        <div class="col-sm-10">
            <select name="second_class_id" class="col-xs-10 col-sm-5">
                ...
                <option value="<?= $menu['class_id'] ?>"><?= $menu['class_name'] ?></option>
                <?php endforeach;?>
            </select>
            <span class="help-inline col-xs-12 col-sm-7">
    ...
    <div class="form-group">
        ...
        <div class="col-sm-10">
            <select name="origin_place_id" class="col-xs-10 col-sm-5">
                ...
                <option value="<?= $place['origin_place_id'] ?>"><?= $place['origin_place_name'] ?></option>
                <?php endforeach;?>
            </select>
            <span class="help-inline col-xs-12 col-sm-7">
    ...
    <div class="form-group">
        ...
        <div class="col-sm-10">
            <input type="text" name="product_no" placeholder="" class="col-xs-10 col-sm-5" />
        </div>
    </div>
    ...
    <div class="form-group">
        ...
        <div class="col-sm-10">
            <input type="text" name="product_name" placeholder="" class="col-xs-10 col-sm-5" />
        </div>
    </div>
    ...
    <div class="form-group">
        ...
        <div class="col-sm-10">
            <input type="text" name="product_brief" placeholder="" class="col-xs-10 col-sm-5" />
        </div>
    </div>
    ...
    <div class="form-group">
        ...
        <div class="col-sm-10">
            <input type="text" name="origin_price" placeholder="0.00" class="col-xs-10 col-sm-5" />
        </div>
    </div>
    ...
    <div class="form-group">
        ...
        <div class="col-sm-10">
            <input type="text" name="discount_price" placeholder="0.00" class="col-xs-10 col-sm-5" />
        </div>
    </div>
    ...
    <div class="form-group">
        ...
        <div class="col-sm-10">
            <input type="text" name="storage_method" placeholder="" class="col-xs-10 col-sm-5" />
        </div>
    </div>
    ...
    <div class="form-group">
        ...
        <div class="col-sm-10">
            <input type="text" name="product_remark" placeholder="" class="col-xs-10 col-sm-5" />
        </div>
    </div>
    ...
    <div class="form-group">
        ...
        <div id="editor" class="col-sm-10">
            <textarea id='edit' style="margin-top: 30px;" name="product_detail"></textarea>
        </div>
    </div>
