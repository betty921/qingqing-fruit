...
<div class="row">
	<div class="col-sm-3">
		...
		<form action="?r=classification/add" method="post">
			...
			<div class="form-group">
				<label>别名</label>
				<input type="text" name="other_name" class="form-control" placeholder="">
			</div>
	...
	<div class="col-sm-9">
		...
		<table id="sample-table-1" class="table table-striped table-bordered table-hover">
            ...
            <tr>
				...
				<td><?= $class['other_name'] ?></td>
                <td><a href="?r=classification/del&class_id=<?= $class['class_id'] ?>">删除</a> | <a href="?r=classification/update&class_id=<?= $class['class_id'] ?>">编辑</a> </td>
            </tr>
            <?php endforeach; ?>
            <?php endif;?>
