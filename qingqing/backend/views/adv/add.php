...
<form class="form-horizontal" role="form" action="?r=adv/add" method="post">
	...
	<div class="form-group">
		...
		<div class="col-sm-10">
			<select name="position" class="col-xs-10 col-sm-5">
				...
				<option value="2">首页推荐位</option>
				<option value="3">首页中部横幅广告</option>
			</select>
		</div>
	</div>
	...
	<div class="form-group">
		...
		<div class="col-sm-10">
			<input type="text" name="desc" placeholder="" class="col-xs-10 col-sm-5" />
		</div>
	</div>
	...
	<div class="form-group">
		...
		<div class="col-sm-10">
			<input type="text" name="url" placeholder="" class="col-xs-10 col-sm-5" />
		</div>
	</div>
