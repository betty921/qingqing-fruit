...
$styleInfos = $GLOBALS['styleInfos'];
//var_dump($styleInfos);die;
					...
					<div class="page-content">
						...
						<div class="row">
							<div class="col-xs-12">
								...
								<form class="form-horizontal" role="form" action = "?c=Style&m=editStyle" method = "get">
                                   <input type= "text" name= "c" value = "Style" hidden>
                                   <input type = "text" name = "m" value = "editStyle" hidden>
                                   <input type = "text" name = "product_style_id" value = "<?php echo $styleInfos['product_style_id'];?>" hidden>
									<div class="form-group">
										...
										<div class="col-sm-7">
											...
											<option value = "<?php echo $styleInfos['product_id'];?>"><?php echo $key['product_name'];?></option>
											    <?php endforeach;?>
											</select>
									...
									<div class="form-group">
										...
										<div class="col-sm-7">
											...
											<option value = "<?php echo $styleInfos['color_id'];?>"><?php echo $key['color_name'];?></option>
											<?php endforeach;?>
											</select>
									...
									<div class="form-group">
										...
										<div class="col-sm-7">
											...
											<option value = "<?php echo $styleInfos['size_id'];?>" style="text-align:center;line-height:50px"><?php echo $key['size_name'];?></option>
											<?php endforeach;?>
											</select>
										</div>
									</div>
										...
										<div class="col-sm-7">
											<input type = "text" name = "stock" value = "<?php echo $styleInfos['stock'];?>">
										</div>
									</div>
									...
									<div class="form-group">
										...
										<div class="col-sm-7">
											<input type = "text" value = "<?php echo $styleInfos['sell_num'];?>" name = "sell_num">
										</div>
									</div>
