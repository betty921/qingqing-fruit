					...
					<div class="page-content">
						...
						<div class="row">
							<div class="col-xs-12">
								...
								<form class="form-horizontal" role="form" action = "?c=Popular&m=editPopular" method = "get">
                                   <input type= "text" name= "c" value = "Popular" hidden>
                                   <input type = "text" name = "m" value = "editPopular" hidden>
                                   <input type = "text" name = "popular_category_id" value= "<?php echo $popularInfos['popular_category_id'];?>" hidden>
									<div class="form-group">
										<label class="col-sm-3 control-label no-padding-right" for="x"> 分类名 </label>
										<div class="col-sm-7">
											<input id="x" name = "popular_category_name" value= "<?php echo $popularInfos['popular_category_name'];?>" type="text" class="input-small" />
										</div>
									</div>
										...
										<div class="col-sm-4">
											...
											<div class="widget-box">
												<div class="widget-body">
													<input type="file" value= "<?php echo $popularInfos['popular_img'];?>" id="id-input-file-1" onchange="UpFileImage(this,'http://localhost:8088/testPHP/hibuy/resource1/index.php')"/>
													<div class="widget-main">
														<div class="row">
															<ul class="ace-thumbnails" id="list_image_src" >
																<li><a href="" id = "pre_img_a" title="Photo Title" data-rel="colorbox"><img src="" id = "pre_img_img" ></a><div class="tools">
																		<a href="javascript:void(0);" onclick="DeleteImage(this);">
																			<i class="icon-remove red"></i>
																		</a>
																	</div><input type="text" value=""  name = "popular_img" hidden></li>
...
<![endif]-->
    ...
    function UpFileImage(elem,url){
 			...
 			ajaxUpFile(url,formData,function(respTest){
				...
				document.getElementsByName('popular_img')[0].value = img_url;
 	 			})
        }
	</script>
</body>
