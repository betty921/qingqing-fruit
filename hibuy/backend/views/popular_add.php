					...
					<div class="page-content">
						...
						<div class="row">
							<div class="col-xs-12">
								...
								<form class="form-horizontal" role="form" action="?c=Popular&m=showAddPopular" >
                                     <input type= "text" name= "c" value = "Popular" hidden>
                                   <input type = "text" name = "m" value = "showAddPopular" hidden>
													...
													<div class="widget-main">
														<div class="row">
															<ul class="ace-thumbnails" id="list_image_src" >
																<li>
																<a href="" id ="pre_img_a" title="Photo Title" data-rel="colorbox">
																<img id ="pre_img_img" src="" style = "width:300px;height:300px;"></a>
																<div class="tools">
...
<![endif]-->
   ...
   /*  function Submit() {
		...
		var popular_img =  document.getElementsByName('popular_img')[0].value;
		if( popular_category_name=='' || popular_img=='') {
			alert('请检测参数');
			return;
		}
		var formdata = new FormData();
		formdata.append('popular_category_name',popular_category_name);
		formdata.append('popular_img',popular_img);

		ajaxUpFile('?c=Popular&m=AddPopular', formdata, function (respText) {
