					...
					<div class="page-content">
						...
						<div class="row">
							<div class="col-xs-12">
								...
								<form class="form-horizontal" role="form" action = "?c=Product&m=showAddProduct" method = "get">
                                   <input type= "text" name= "c" value = "Product" hidden>
                                   <input type = "text" name = "m" value = "showAddProduct" hidden>
									...
									<div class="form-group">
										...
										<div class="col-sm-7">
											<input type = "text" name = "product_subname">
										</div>
									</div>
									...
									<div class="form-group">
										...
										<div class="col-sm-7">
											<input type = "text" name = "origin_price">
										</div>
									</div>
