					...
					<div class="page-content">
						...
						<div class="row">
							<div class="col-xs-12">
								...
								<form class="form-horizontal" role="form" action = "?c=Category&m=editCategory" method = "get">
                                   <input type= "text" name= "c" value = "Category" hidden>
                                   <input type = "text" name = "m" value = "editCategory" hidden>
                                   <input type="text" name="category_id" value="<?php echo $categoryInfos['category_id'];?>" hidden>
									<div class="form-group">
										<label class="col-sm-3 control-label no-padding-right" for="x"> 分类名 </label>
										<div class="col-sm-7">
											<input id="x" name="category_name" value="<?php echo $categoryInfos['category_name'];?>" type="text" class="input-small" />
										</div>
									</div>
										...
										<div class="col-sm-4">
											...
											<div class="widget-box">
												<div class="widget-body">
													<input type="file"  id="id-input-file-1" value="<?php echo $categoryInfos['category_img'];?>" onchange="UpFileImage(this,'http://localhost:8088/testPHP/hibuy/resource1/index.php')"/>
