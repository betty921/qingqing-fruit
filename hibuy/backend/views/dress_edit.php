					...
					<div class="page-content">
						...
						<div class="row">
							<div class="col-xs-12">
								...
								<form class="form-horizontal" role="form" action = "?c=Dress&m=editDress" method = "get">
                                   <input type= "text" name= "c" value = "Dress" hidden>
                                   <input type = "text" name = "m" value = "showAddDress" hidden>
                                   <input type = "text" name = "dress_id" value = "<?php echo $dressInfos['dress_id'];?>" hidden>
									<div class="form-group">
										<label class="col-sm-3 control-label no-padding-right" for="x"> 分类名 </label>
										<div class="col-sm-7">
											<input id="x" name = "dress_name" value = "<?php echo $dressInfos['dress_name'];?>" type="text" class="input-small" />
										</div>
									</div>
										...
										<div class="col-sm-4">
											...
											<div class="widget-box">
												<div class="widget-body">
													<input type="file"  value = "<?php echo $dressInfos['dress_img'];?>" id="id-input-file-1" onchange="UpFileImage(this,'http://localhost:8088/testPHP/hibuy/resource1/index.php')"/>
													<div class="widget-main">
														<div class="row">
															<ul class="ace-thumbnails" id="list_image_src" >
																<li><a href="" id = "pre_img_a" title="Photo Title" data-rel="colorbox"><img src="" id = "pre_img_img" style = "width:100px;height:auto"></a><div class="tools">
