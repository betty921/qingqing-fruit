			...
			<div class="main-container-inner">
				...
				<div class="sidebar" id="sidebar">
					...
					<ul class="nav nav-list">
						...
						<li>
							<a href="Category_add.html" class="dropdown-toggle">
								<i class="icon-desktop"></i>
						...
						<li>
							<a href="match_add.html" class="dropdown-toggle">
								<i class="icon-desktop"></i>
								<span class="menu-text"> 潮流搭配管理 </span>
